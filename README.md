...
Нахожу баги раньше, чем они находят вас. :grin:

### 🔍 Кто я
Я специалист по ручному тестированию веб‑приложений. В работе использую Postman для тестирования API, взаимодействую с БД, анализирую логи. Имею опыт работы с Figma для проверки соответствия интерфейса макетам и с баг‑трекинговыми системами для заведения и отслеживания дефектов.

Люблю разбираться в деталях, находить неочевидные баги и делать продукты лучше. Быстро осваиваю новые инструменты и легко встраиваюсь в команду. Моя цель — помогать создавать надёжные и удобные решения.

Инструменты: Postman, Figma, Jira, SQL (базовые запросы). Готова к новым задачам и профессиональному росту в сфере QA.
