...
Проект: тренажёр «Битва покемонов»
...
В рамках стажировки я выполняла комплексное тестирование веб‑приложения «Битва покемонов», включая:

- составление чек-лист проверок в Miro, баг-репорты заводила в Buildin;

- тестирование API через Swagger и Postman;

- проверку UI‑элементов веб‑интерфейса.
